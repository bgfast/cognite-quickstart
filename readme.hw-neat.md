...
├── generate_cdf_dm_yaml_files_via_neat.py               # NEAT YAML generation script (MANUALLY MAINTAINED)
...
- `generate_cdf_dm_yaml_files_via_neat.py` - Generation script
...
- Regenerate these by running `python generate_cdf_dm_yaml_files_via_neat.py`
...
2. **Regenerate YAML**: Run `python generate_cdf_dm_yaml_files_via_neat.py`
